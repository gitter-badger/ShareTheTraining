...
function setDetailPage(item) {
    ...
    $("#certification").val(item.certification);
...
function disableFields() {
    ...
    $("#education").attr("readonly", true);
    $("#certification").attr("readonly", true);
    $("#howfar").attr("readonly", true);
    $("#company").attr("readonly", true);
    $("#companyInfo").attr("readonly", true);
...
$(document).ready(function () {
    ...
    $(document).on("click", "#schedule", function () {
        var id = $("#id").val();
        //open new window to show this trainer's schedule
        console.log(id);
    });
});